...
def load_dish(apps, schema_editor):
    ...
    dish1 = Dish(user=chino,name='carne mongoliana',image="img/rice.png", description='La carne mongoliana más rica que hayan probado',stock=20,price=2990)
    dish1.save()

    dish2 = Dish(user=chino,name='pollo mongoliano',image='img/rice.png',description='El pollo mongoliano mas ricoque hayan probado',stock=10,price=1990)
    dish2.save()

    dish3 = Dish(user=empanada,name='empanada de pino',image='img/rice.png',description='Empanada cacera con pino de carne mechada',stock=15,price=1000)
    dish3.save()

    dish4 = Dish(user=empanada,name='empanada de queso',image='img/rice.png',description='Empanada hecha con queso de campo',stock=5,price=1000)
    dish4.save()

    dish5 = Dish(user=lunchbox,name='arroz con pollo',image='img/rice.png',description='El mejor lunchbox que has omido',stock=8,price=2500)
    dish5.save()

    dish6 = Dish(user=sushi,name='sushi tempura',image='img/rice.png',description='Sushi relleno de pollo, queso crema y ciboulette',stock=12,price=1200)
    dish6.save()

    dish7 = Dish(user=pepe,name='lasagna',image='img/rice.png',description='Lasagna cacera con pino de lomo liso y pasas carozzi', stock=3,price=2300)
    dish7.save()
...
def delete_dishes(apps, schema_editor):
    ...
    Dish.objects.get(user=chino ,name='pollo mongoliano').delete()
